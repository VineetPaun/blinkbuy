...
export const categories: Category[] = [
  { id: "fruits-vegetables", name: "Fruits & Vegetables", icon: "🥬", image: "/categories/fruits.jpg" },
  { id: "dairy-bread", name: "Dairy, Bread & Eggs", icon: "🥛", image: "/categories/dairy.jpg" },
  { id: "rice-oil-dals", name: "Atta, Rice, Oil & Dals", icon: "🍚", image: "/categories/rice.jpg" },
  { id: "meat-fish", name: "Meat, Fish & Eggs", icon: "🥩", image: "/categories/meat.jpg" },
  { id: "masala-dry-fruits", name: "Masala & Dry Fruits", icon: "🌶️", image: "/categories/masala.jpg" },
  { id: "breakfast-sauces", name: "Breakfast & Sauces", icon: "🥣", image: "/categories/breakfast.jpg" },
  { id: "packaged-food", name: "Packaged Food", icon: "📦", image: "/categories/packaged.jpg" },
  { id: "beverages", name: "Tea, Coffee & More", icon: "☕", image: "/categories/beverages.jpg" },
  { id: "ice-cream", name: "Ice Creams & More", icon: "🍦", image: "/categories/icecream.jpg" },
  { id: "frozen-food", name: "Frozen Food", icon: "❄️", image: "/categories/frozen.jpg" },
  { id: "laundry-care", name: "Laundry Care", icon: "🧺", image: "/categories/laundry.jpg" },
  { id: "cleaning", name: "Cleaning Essentials", icon: "🧹", image: "/categories/cleaning.jpg" },
];
