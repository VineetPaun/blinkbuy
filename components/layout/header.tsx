    ...
    <>
          ...
          <div className="flex items-center gap-4 h-16">
            ...
            <div className="hidden md:flex items-center justify-center ml-4">
              <div className="flex items-center gap-1 text-primary">
                <SafeIcon icon={FlashIcon} className="size-8" />
            ...
            {/* GitHub Link
            <a
              href="https://github.com/ahan1904"
              target="_blank"
              ...
              {isLoaded && !isSignedIn && (
                <SignInButton mode="modal">
                  <Button variant="outline" size="sm" className="gap-2">
                    <SafeIcon icon={Login01Icon} className="size-4" />
                    Login
                  </Button>
                </SignInButton>
              )}
            ...
            {isLoaded && isSignedIn && (
              ...
              >
                <SafeIcon icon={ShoppingCart01Icon} className="size-5" />
                {totalItems > 0 ? (
      ...
      <div className="md:hidden border-b border-border px-4 py-2 flex justify-center bg-primary/5">
        <div className="flex items-center gap-2 text-primary">
          <SafeIcon icon={FlashIcon} className="size-5" />
